...
<div id="main_left">
   ...
   <c:forEach items="${requestScope.posts }" var="post">
    ...
    <div id="item_content">
      ...
      <div id="block">
        <div id="pic">
        	<img src="<%=basePath%>/nxt/images/example/01.jpg"class="img-thumbnail" style="height:70px; width:70px;" />
        </div>
...
<div id="main_right">
    ...
    <hr>
    <div id="hot_group">
    	<div id="group_image"><img src="<%=basePath%>/nxt/images/favicon/g459388-1.jpg" class="thumbnail"></div>
