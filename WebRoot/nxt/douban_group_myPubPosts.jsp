...
<div id="personal_group_leftside">
    ...
    <div id="mygroup_nav">
        ...
        <a href="groupServlet?method=queryUserPub&&user_id=${sessionScope.current_user.user_id}" style="background-color: #6EBFC3;border-radius:3px;color: #fff;">发起</a>
        <a href="groupServlet?method=queryUserReply&&user_id=${sessionScope.current_user.user_id}">回应</a>
    </div><hr><br>
    <!--end of mygroup_nav-->
    
  
    <div id="space">发起的话题</div><hr>
    	<div class="mod_topic">
        	<table class="olt">
        	<tr class="pl">
        			<td class="title">
